# 📦 Rack37 HTML Boilerplate

[![License: MIT]](https://opensource.org/licenses/MIT)

Rack37 HTML boilerplate using Babel, PostCSS and Sass with a hot dev server and an optimized production build.
...
This project is developed for Rack37 and available under the [MIT License](LICENSE).
